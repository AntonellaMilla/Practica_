...
const ItemDetail = () => {
  ...
  // Obtener item desde el state de navegación o desde el store
    ...
    return (
      <div className="container">
        <div className="text-center py-5">
          ...
          <p className="text-muted">El elemento que buscas no existe o no está disponible.</p>
  ...
  // Obtener nombre de API más amigable
